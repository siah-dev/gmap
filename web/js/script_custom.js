...
function montarFiltros(x){
  ...
  console.log(x);
	$.each(x,function(i,v){
    console.log(v);
		a += '<div class=\'legend\'><label><input type=\'checkbox\' name=\'tipo_estabelecimento[]\' id=\'filtroLegenda\' value="'+v.id+'" onclick=\'ajaxRequestLegendas()\' ><img src=\"../img/marcadores/'+v.img+'" alt="'+v.tipo+'" />'+v.tipo+'</label></div>';
	});
	return a;
}
