...
<?php $this->beginBody() ?>
    <div class="wrap">
        <?php
            NavBar::begin([
                'brandLabel' => '<img src=\''.Yii::$app->getUrlManager()->getBaseUrl().'/img/gov_para.png\' alt=\'GOVERNO DO PARÁ\' />',
                'brandUrl' => 'http://www.pa.gov.br/',
                'options' => [
    ...
    <footer class="footer">
        <div class="container">
            ...
            <p class="pull-right"><img src="<?= Yii::$app->getUrlManager()->getBaseUrl()?>/img/sespa.png" /><?php //Yii::powered() ?></p>
        </div>
    </footer>
